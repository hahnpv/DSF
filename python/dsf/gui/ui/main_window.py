...
class MainWindow(QMainWindow):
    ...
    def _setup_ui(self):
        ...
        from dsf.gui.ui.canvas import GraphScene, GraphView
        from dsf.gui.ui.palette import PaletteWidget
        from dsf.gui.ui.inspector import InspectorWidget # Keep original InspectorWidget import
        from dsf.utils.serializer import GraphSerializer
        ...
        from dsf.gui.ui.inspector import InspectorWidget
    ...
    def load_library_file(self, path):
        ...
        try:
            ...
            from dsf.gui.core.model_registry import PropertyDefinition, PortDefinition
    ...
    def _export_xml(self):
        ...
        from dsf.utils.xml_generator import XMLGenerator
    ...
    def import_xml_file(self, path):
        import os
        from PyQt6.QtWidgets import QMessageBox
        from dsf.utils.xml_parser import XMLParser
        from dsf.gui.ui.canvas import BlockItem
    ...
    def _paste_selection(self):
        ...
        try:
            ...
            from dsf.gui.core.commands import AddBlockCommand
            from dsf.gui.ui.canvas import BlockItem
    ...
    def _probe_headers(self):
        ...
        from dsf.gui.execution.simulation_worker import SimulationWorker
